  ...
  <div class="">
      <form action="/skor-pertandingan" method="POST">
        ...
        <select id="countries" class="border text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500" name="id_klub2">
         ...
         <input type="text" id="skor_1" name="skor_1" class="block py-2 px-4 text-sm border rounded-lg w-80 bg-gray-800/40 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500" placeholder="Masukkan nama klub" autocomplete="off">
         <input type="text" id="skor_2" name="skor_2" class="block py-2 px-4 text-sm border rounded-lg w-80 bg-gray-800/40 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500" placeholder="Masukkan nama klub" autocomplete="off">
         @error('id_klub1')
            <div>error</div>
         @enderror
