...
<div class="py-4 md:px-3">
  ...
  <div class="">
      <form action="/klub" method="POST">
         @csrf
         <input type="text" id="nama_klub" name="nama_klub" class="block py-2 px-4 text-sm border rounded-lg w-80 bg-gray-800/40 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500" placeholder="Masukkan nama klub" autocomplete="off">
         <input type="text" id="kota_klub" name="kota_klub" class="block py-2 px-4 text-sm border rounded-lg w-80 bg-gray-800/40 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500" placeholder="Masukkan nama klub" autocomplete="off">
         @error('nama_klub')
            <div>error</div>
         @enderror
