...
<aside id="separator-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 border-r border-gray-800" aria-label="Sidebar">
   <div class="h-full px-3 py-4 overflow-y-auto bg-gray-900">
     ...
     <ul class="space-y-2 font-medium">
       <li>
         <a href="/klasemen" class="flex items-center p-2 rounded-lg text-gray-400 hover:bg-gray-800">
       ...
       <li>
         <a href="/klub" class="flex items-center p-2 rounded-lg text-gray-400 hover:bg-gray-800">
           <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white">
       ...
       <li>
         <a href="/skor-pertandingan" class="flex items-center p-2 rounded-lg text-gray-400 hover:bg-gray-800">
